'''
Author: Jadedever
Date: 2022-05-15 14:18:30
LastEditors: Jadedever
LastEditTime: 2022-05-15 14:18:32
FilePath: /Python_Homework/lesson_10/水木清华论坛帖子爬取.py
Description: 
...
def parse_list_page(text):
  ...
  tbody = soup.select('table.board-list.tiz > tbody')
  urls = []
  for tr in tbody:
    td = soup.select('td.title_9')
...
def parse_content_page(text):
  ...
  contents = []
  for awrap in content_div.select('div.a-wrap.cornet'):
